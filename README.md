...
Este projeto tem como objetivo desenvolver as habilidades no desenvolvimento de uma aplicação com a utilização de Angular e tailwindCSS.
O app é um rpg simples orientado a objetos com diversas funcionalidades e ações .

## Endereço de Deploy - GitHub Pages

https://faboborgeslima.github.io/rpg

## Protótipo

https://www.figma.com/file/gwx3h3BsG6bEjud1YKm5bd/rpg?type=design&node-id=2-2&mode=design&t=lVV6IFEwxvkspcjU-0
